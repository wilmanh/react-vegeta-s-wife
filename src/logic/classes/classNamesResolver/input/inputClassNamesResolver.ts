...
import { ColorClassNameResolver } from '../color/colorClassNamesResolver';
import { SizeClassNameResolver } from '../size/sizeClassNamesResolver';
import { StateClassNameResolver } from '../state/stateClassNamesResolver';
